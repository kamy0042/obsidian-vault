...
URL: https://fintan.jp/?p=1375
URL 1: ""
Tags: [topic/技術/ソフトウェア設計]
---
- [サンプルコード](https://github.com/Fintan-contents/case-studies/blob/master/hexagonal-architecture/samplecode.md)

### **はじめに**

このドキュメントは、変更の要求が激しいソフトウェア開発プロジェクトにおいて、ソフトウェアアーキテクチャの1つであるヘキサゴナルアーキテクチャを導入した結果を事例としてまとめたものになります。ヘキサゴナルアーキテクチャを導入した結果、ソフトウェアを要求の変更に対して追従させやすくなりました。本ドキュメントを通じて、以下の情報を知ることができます。
...
![](https://i2.wp.com/fintan.jp/wp-content/uploads/2019/07/adjustment-layer.png?resize=725%2C394&ssl=1)
...
![](https://i2.wp.com/fintan.jp/wp-content/uploads/2019/07/about-hexagonal-architecture.png?resize=725%2C391&ssl=1)
...
ヘキサゴナルアーキテクチャを導入した結果のアーキテクチャを説明します。以下に構築したシステムのアーキテクチャの概要図を示します。

図3　ヘキサゴナルアーキテクチャ導入後アーキテクチャ

![](https://i0.wp.com/fintan.jp/wp-content/uploads/2019/07/architecture-after-implementation.png?resize=725%2C462&ssl=1)
...
![](https://i0.wp.com/fintan.jp/wp-content/uploads/2019/07/architecture-up-to-now.png?resize=725%2C457&ssl=1)
...
![](https://i2.wp.com/fintan.jp/wp-content/uploads/2019/07/violation-of-dependency-rule-between-layers.png?resize=725%2C333&ssl=1)
...
![](https://i1.wp.com/fintan.jp/wp-content/uploads/2019/07/separate-interface-pattern.png?resize=725%2C333&ssl=1)

### **依存性逆転の法則とレジストリ**

**DIコンテナから永続化に関するクラスのインスタンスを取得できるようにし、ビジネスロジックの独立性を向上させました。また、レジストリパターンを利用しDIコンテナに関するコードがビジネスロジックで分散しないようにしました。**

セパレートインターフェースパターンを適用したことによりビジネスロジックを独立して定義できるようにしましたが、実際にソフトウェアが動作するにはインターフェースに対応する具象クラスをインスタンス化する必要があります。しかし、直接クラスをインスタンス化するとビジネスロジックが特定の技術要素に依存してしまいます。

図7　具象クラスのインスタンス化による依存ルール違反

![](https://i1.wp.com/fintan.jp/wp-content/uploads/2019/07/dependency-rule-violation-due-to-instantiation-of-concrete-class.png?resize=725%2C370&ssl=1)
...
![](https://i1.wp.com/fintan.jp/wp-content/uploads/2019/07/using-the-law-of-dependency-inversion-and-the-registry.png?resize=725%2C359&ssl=1)
...
![](https://i2.wp.com/fintan.jp/wp-content/uploads/2019/07/order-and-timing-of-layer-focusing.png?resize=725%2C440&ssl=1)
...
![](https://i0.wp.com/fintan.jp/wp-content/uploads/2019/07/change-in-adapter-layer.png?resize=457%2C725&ssl=1)
...
![](https://i1.wp.com/fintan.jp/wp-content/uploads/2019/07/time-and-Implementation-Function-Graph.png?resize=725%2C479&ssl=1)
...
本コンテンツは[*クリエイティブコモンズ*](https://creativecommons.org/licenses/by-sa/4.0/)[(](https://creativecommons.org/licenses/by-sa/4.0/)[*Creative Commons) 4.0 の「*](https://creativecommons.org/licenses/by-sa/4.0/)[*表示—継承」*](https://creativecommons.org/licenses/by-sa/4.0/)*に準拠しています。*