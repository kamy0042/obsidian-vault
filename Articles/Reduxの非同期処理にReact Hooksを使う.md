...
URL: https://yo7.dev/articles/redux-async-hook
Tags: [topic/技術/React]
---
...
![](https://i.gyazo.com/eebd780b4a43e03c3dd32ec6afc643ab.gif)
...
- `actions/ - notes.ts - config.ts
- reducers/ - notes.ts - config.ts`

`re-ducks`のディレクトリ構成

- `modules/ - notes - index.ts - actions.ts - reducer.ts - selectors.ts - operations.ts`
...
*Photo by Mel Poole on *[*Unsplash*](https://unsplash.com/photos/Hg-uNVsg65Y)