---
タグ: []
作成日時: 2023-12-10T03:29:00
URL: https://zenn.dev/yumemi_inc/articles/do-not-let-the-storybook-rot
Tags: [topic/ツール/Storybook]
---
[YUMEMI New Grad Advent Calendar 2023](https://qiita.com/advent-calendar/2023/yumemi-23-graduation)

![[aa11e374f2f8-20231205.png]]
...
# [Why Storybook? • Storybook docs](https://storybook.js.org/docs/get-started/why-storybook)

[Storybook is a frontend workshop for building UI components and pages in isolation. Thousands of teastorybook.js.org](https://storybook.js.org/docs/get-started/why-storybook)
...
Scaffoldツールは例えば[scaffdog](https://scaff.dog/)、[Plop](https://plopjs.com/)、[TurborepoのCode Generator（](https://turbo.build/repo/docs/reference/command-line-reference/gen)[`turbo gen`](https://turbo.build/repo/docs/reference/command-line-reference/gen)[）](https://turbo.build/repo/docs/reference/command-line-reference/gen)、[Hygen](https://www.hygen.io/)などがあります。

# [scaffdog - Markdown driven scaffolding tool.](https://scaff.dog/)

[Markdown driven scaffolding tool. scaffdog speeds up the first steps of your creative activity.scaff.dog](https://scaff.dog/)

# [Plop: Consistency Made Simple](https://plopjs.com/)

[A little tool that saves you time and helps your team build new files with consistency. Generate codplopjs.com](https://plopjs.com/)

# [turbo gen – Turborepo](https://turbo.build/repo/docs/reference/command-line-reference/gen)

[Turborepo CLI Reference for gen commandturbo.build](https://turbo.build/repo/docs/reference/command-line-reference/gen)
