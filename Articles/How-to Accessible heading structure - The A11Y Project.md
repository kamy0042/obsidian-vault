---
タグ: []
作成日時: 2022-01-17T12:44:00
URL: https://www.a11yproject.com/posts/how-to-accessible-heading-structure/
Tags: [topic/アクセシビリティ]
---
1. [Headings in HTML](https://www.a11yproject.com/posts/how-to-accessible-heading-structure/#headings-in-html)
2. [Headings in development](https://www.a11yproject.com/posts/how-to-accessible-heading-structure/#headings-in-development)
3. [Tools](https://www.a11yproject.com/posts/how-to-accessible-heading-structure/#tools)
...
> A heading can be used where heading content is expected. Heading content defines the header of a section (whether explicitly marked up using sectioning content elements, or implied by the heading content itself).
...
Using multiple `h1`s was proposed with the introduction of the HTML Document Outline in HTML5. Each section in the outline could contain an H1. But here's the snag: **The Document outline was never adapted by browsers or assistive technology**. Therefore the support for multiple `h1`s was dropped in HTML5.1
...
4. Give the content manager the opportunity to add or change a heading while adding a component.
5. If a component is added by the theme: change the heading level as needed in the code.
...
Thank you to [Steve Faulkner](https://twitter.com/stevefaulkner) for his feedback.
