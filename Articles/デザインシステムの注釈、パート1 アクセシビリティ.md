---
タグ: []
作成日時: 2025-05-10T13:51:00
URL: https://github-blog.translate.goog/engineering/user-experience/design-system-annotations-part-1-how-accessibility-gets-left-out-of-components/?_x_tr_sl=auto&_x_tr_tl=ja
Tags: [topic/デザインシステム/ドキュメント]
---
![](https://github-blog.translate.goog/wp-content/uploads/2025/05/Design-System-Annotations-Part-1.jpg?w=1200&_x_tr_sl=auto&_x_tr_tl=ja)

Some abstract blue shapes contoured with a few git-lines behind text that reads, Design system annotations, part one, How accessibility gets left out of components.

When it comes to design systems, every organization tends to be at a different place in their accessibility journey. Some have put a great deal of work into making their design system accessible while others have a long way to go before getting there. To help on this journey, many organizations rely on [accessibility annotations](https://translate.google.com/website?sl=auto&tl=ja&hl=&u=https%3A%2F%2Ftangible.is%2Fen%2Fthinking%2F2024%2F10%2Fthe-value-of-accessibility-annotations-in-inclusive-design) to make sure there are no access barriers when a design is ready to be built.
...
In this two-part series, we’ll show you exactly how accessible design system components can produce inaccessible designs. Then we’ll demonstrate our solution: integrating annotations with our [Primer](https://translate.google.com/website?sl=auto&tl=ja&hl=&u=https%3A%2F%2Fprimer.style%2F) components. This allows us to spend less time annotating, increases design system adoption, and reaches teams who may not have accessibility support. And in our next post, we’ll walk you through how you can do the same for your own components.

Let’s dig in.

## What are annotations and their benefits?

Annotations are notes included in design projects that help make the unseen explicit by conveying design intent that isn’t shown visually. They improve the usability of digital experiences by providing a holistic picture for developers of how an experience should function. Integrating annotations into our design process helps our teams work better together by closing communication gaps and preventing quality issues, [accessibility audit issues](https://translate.google.com/website?sl=auto&tl=ja&hl=&u=https%3A%2F%2Fwww.w3.org%2FWAI%2Ftest-evaluate%2F), and expensive re-work.

Some of the questions annotations help us answer include:

- How is [assistive technology](https://translate.google.com/website?sl=auto&tl=ja&hl=&u=https%3A%2F%2Ftetralogical.com%2Fblog%2F2021%2F12%2F24%2Fbrowsing-with-assistive-technology-videos%2F) meant to navigate a page from one element to another?
...
- Which [virtual keyboard](https://translate.google.com/website?sl=auto&tl=ja&hl=&u=https%3A%2F%2Fdeveloper.apple.com%2Fdesign%2Fhuman-interface-guidelines%2Fvirtual-keyboards%23Best-practices) should be used for a form input on mobile?
...
- Structural elements such as headings and [landmarks](https://translate.google.com/website?sl=auto&tl=ja&hl=&u=https%3A%2F%2Fdeveloper.mozilla.org%2Fen-US%2Fblog%2Faria-accessibility-html-landmark-roles%2F)
- [Decorative images](https://translate.google.com/website?sl=auto&tl=ja&hl=&u=https%3A%2F%2Ftetralogical.com%2Fblog%2F2022%2F01%2F24%2Ftext-descriptions%2F) and informative descriptions
...
![](https://github-blog.translate.goog/wp-content/uploads/2025/05/Figure-1-Web-Accessibility-Annotation-Kit.png?w=1200&_x_tr_sl=auto&_x_tr_tl=ja)

A browser window showing the Web Accessibility Annotation Kit in the cvs-health/annotations repository.

To this end, last year we began creating an internal Figma library—the [GitHub Annotation Toolkit](https://translate.google.com/website?sl=auto&tl=ja&hl=&u=https%3A%2F%2Fprimer.style%2Faccessibility%2Ftools%2F%23annotation-toolkit-internal) (which we aim to release to the public soon). Our toolkit builds on the legacy of the former Inclusive Design team at CVS Health. Their two [open source annotation kits](https://translate.google.com/website?sl=auto&tl=ja&hl=&u=https%3A%2F%2Fgithub.com%2Fcvs-health%2Fannotations) help make documentation that’s easy to create and consume, and are among the most widely used annotation libraries in the Figma Community.
...
Design systems can also help reduce that overhead. When you [audit your design systems for accessibility](https://translate.google.com/website?sl=auto&tl=ja&hl=&u=https%3A%2F%2Fwww.deque.com%2Fblog%2Fauditing-design-systems-for-accessibility%2F), there’s less need for specialist attention on every product feature, since you’re using annotations to add technical semantics and specialist knowledge into every component. This means that designers and developers only need to adhere to the usage guidelines consistently, right?
...
Most of the time, it will be a misnomer to claim that your design system is “fully accessible.” There’s always more work to do—it’s just a question of how much. The [Web Content Accessibility Guidelines](https://translate.google.com/website?sl=auto&tl=ja&hl=&u=https%3A%2F%2Fwww.a11yproject.com%2Fposts%2Fwcag2-documents%2F) (WCAG) are a great starting point, but their “Success Criteria” isn’t tailored for the unique context that is your website or product or audience.

While the WCAG should be used as a foundation to build from, it’s important to understand that it [can’t capture every nuance](https://translate.google.com/website?sl=auto&tl=ja&hl=&u=https%3A%2F%2Fcerovac.com%2Fa11y%2F2021%2F12%2Fhow-to-know-that-a-website-or-app-is-really-accessible%2F) of disabled users’ needs because **your** users’ needs are not **every** user’s needs. It would be very easy to believe that your design system is “fully accessible” if you never look past WCAG to talk to **your** users. If Primer has accessible components, it’s because we feel that direct participation and input from daily assistive technology users is [the most important aspect of our work](https://github-blog.translate.goog/engineering/user-experience/how-were-building-more-inclusive-and-accessible-components-at-github/?_x_tr_sl=auto&_x_tr_tl=ja). Testing plans with real users—with and without disabilities—is where you really find what matters most.

### Accessible *components* do not guarantee accessible *designs*

Arranging a series of accessible components on a page does not automatically create an accurate and informative heading hierarchy. There’s a good chance that without additional documentation, the heading structure won’t make sense visually—nor as a medium for [navigating with assistive technology.](https://translate.google.com/website?sl=auto&tl=ja&hl=&u=https%3A%2F%2Ftetralogical.com%2Fblog%2F2021%2F09%2F29%2Fbrowsing-with-a-desktop-screen-reader%2F)

![](https://github-blog.translate.goog/wp-content/uploads/2025/05/Figure-2.png?w=1200&_x_tr_sl=auto&_x_tr_tl=ja)
...
Similarly, forms built using the same input components may do different things and require different error validation messages. It’s no wonder that [adopting design system components doesn’t get rid of all audit issues.](https://translate.google.com/website?sl=auto&tl=ja&hl=&u=https%3A%2F%2Fwww.a11yquest.com%2Fblog%2F2024-11-13-component-libraries)
...
![](https://github-blog.translate.goog/wp-content/uploads/2025/05/Figure-3-A-Mysterious-Button.png?w=1200&_x_tr_sl=auto&_x_tr_tl=ja)
...
If we’re using this Primer [Button](https://translate.google.com/website?sl=auto&tl=ja&hl=&u=https%3A%2F%2Fprimer.style%2Freact%2Fstorybook%2F%3Fpath%3D%2Fstory%2Fcomponents-button-features--primary) component from the [Primer Web Figma library](https://translate.google.com/website?sl=auto&tl=ja&hl=&u=https%3A%2F%2Fwww.figma.com%2Fcommunity%2Ffile%2F854767373644076713), there are a few important things that we won’t know just by looking at the design or the component properties:

- **Functional differences when components are implemented.** Is this a link that just looks visually like a button? If so, a developer would use the [`<LinkButton>`](https://translate.google.com/website?sl=auto&tl=ja&hl=&u=https%3A%2F%2Fprimer.style%2Freact%2Fstorybook%2F%3Fpath%3D%2Fstory%2Fcomponents-linkbutton--default) React component instead of `<Button>`.
- **Accessible labels for folks using assistive technology.** The icon may need alt text. In some cases, the button text might need some [visually-hidden text](https://translate.google.com/website?sl=auto&tl=ja&hl=&u=https%3A%2F%2Fwebaim.org%2Ftechniques%2Fcss%2Finvisiblecontent%2F) to differentiate it from similar buttons. How would we know what that text is? Without annotations, the Figma component doesn’t have a place to display this.
...
![](https://github-blog.translate.goog/wp-content/uploads/2025/05/Figure-4-Annotated-Primer-Brand-Accordion.png?w=1390&_x_tr_sl=auto&_x_tr_tl=ja)
...
![](https://github-blog.translate.goog/wp-content/uploads/2025/05/Figure-5-Primer-Brand-Accordion-with-Preset-annotations.png?w=1390&_x_tr_sl=auto&_x_tr_tl=ja)
...
![](https://github-blog.translate.goog/wp-content/uploads/2025/05/Figure-6-Primer-A11y-Presets.png?w=1200&_x_tr_sl=auto&_x_tr_tl=ja)
...
Those Primer components tend to contribute to more accessibility audit issues when key details are missing on implementation. Issues for these components relate to things like lack of proper labels, error validation messages, or missing HTML or [ARIA attributes](https://translate.google.com/website?sl=auto&tl=ja&hl=&u=https%3A%2F%2Ftetralogical.com%2Fblog%2F2023%2F02%2F10%2Ffoundations-wai-aria%2F).

![](https://github-blog.translate.goog/wp-content/uploads/2025/05/Figure-7-IconButton-with-guidance.png?w=1200&_x_tr_sl=auto&_x_tr_tl=ja)

IconButton Preset annotation, with guidance toggled on.

Each of our Preset annotations is linked to component docs and [Storybook](https://translate.google.com/website?sl=auto&tl=ja&hl=&u=https%3A%2F%2Fprimer.style%2Freact%2Fstorybook%2F) demos. This will hopefully help developers get straight to the technical info they need without designers having to find and add links manually. We also included guidance for how to fill out each Preset, as well as how to use the component in an accessible way. This helps designers get support inline without leaving their Figma canvas.

## Want to create your own? Check out Design system annotations, part 2

Button components in Google’s [Material Design](https://translate.google.com/website?sl=auto&tl=ja&hl=&u=https%3A%2F%2Fm3.material.io%2F) and Shopify’s [Polaris](https://translate.google.com/website?sl=auto&tl=ja&hl=&u=https%3A%2F%2Fpolaris.shopify.com%2F), IBM’s [Carbon](https://translate.google.com/website?sl=auto&tl=ja&hl=&u=https%3A%2F%2Fcarbondesignsystem.com%2F), or our Primer design system are all very different from one another. Because Preset annotations are based on specific components, they only work if you’re also using the design system they’re made for.

[**In part 2 of this series**](https://github-blog.translate.goog/engineering/user-experience/design-system-annotations-part-2-advanced-methods-of-annotating-components/?_x_tr_sl=auto&_x_tr_tl=ja), we’ll walk you through how you can build your own set of Preset annotations for your design system, as well as some different ways to document important accessibility details before development starts.

## You may also like:

If you’re more of a visual learner, you can watch [Alexis Lucio](https://translate.google.com/website?sl=auto&tl=ja&hl=&u=https%3A%2F%2Fprimer.style%2Fabout%2F%23alexislucio) explore Preset annotations during GitHub’s [Dev Community Event](https://translate.google.com/website?sl=auto&tl=ja&hl=&u=https%3A%2F%2Fgithubday0.splashthat.com%2F) to kick off Figma’s Config 2024.

![](https://www.youtube.com/embed/bNweRLxWxGA?list=PL0lo9MOBetEG5P2wUZYfUUehbYArAgpng)