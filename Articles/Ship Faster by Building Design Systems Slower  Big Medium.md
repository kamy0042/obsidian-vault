---
タグ: []
作成日時: 2023-12-01T18:53:00
URL: https://bigmedium.com/ideas/design-system-pace-layers-slow-fast.html
...
It’s a signature trait of design system teams to believe they’re moving too slow and must move faster. In [Big Medium’s work](https://bigmedium.com/hire/) guiding and building [dozens of enterprise design systems](https://bigmedium.com/projects/), we see it over and over again:
...
![](https://bigmedium.com/vids/pace-layers-one-orbit.webm)
...
![](https://bigmedium.com/vids/pace-layers-two-orbits.webm)

Back in 1999, Stewart Brand applied this to how civilization works in his book, [The Clock of the Long Now](https://www.amazon.com/Clock-Long-Now-Responsibility-Computer/dp/0465007805/). Instead of orbits, think of geological layers that move at different speeds but are all part of one whole. Brand called these *pace layers.*

Stewart Brand’s original diagram of pace layers from his book, The Clock of the Long Now (1999).

![[stewart-brand-pace-layers.orig-2000.png]]
...
[Click to enlarge](https://bigmedium.com/bm.pix/design-system-pace-layers.png)

![[design-system-pace-layers.orig-2000.png]]
...
That’s in the context of visual brand, which moves more slowly but often has epochal shifts like a rebrand, or maybe has new brands come and go with white-labeling, for example.[[1]](https://bigmedium.com/ideas/design-system-pace-layers-slow-fast.html#fn:82730)
...
We call these solutions *recipes.* Recipes are UI patterns that are cooked up in whole or in part from design system ingredients (components, design tokens, icons and/or styles). [Recipes are their own layer of the design system ecosystem.](https://bigmedium.com/ideas/design-system-ecosystem.html#recipelayeroptional) These recipes are not part of the core system itself, but are examples of how the system can be used—or even first-draft proposals for new features for the system. Product teams often have entire cookbooks of pattern recipes built out of design system goodies. These cookbooks are often represented by their own Figma libraries, code repos, and style guides. While Google’s Material design system provides lots of building-block components, for example, Google products like Calendar, YouTube, or GMail all have their own product-specific pattern recipes that they maintain themselves, to serve their specific domains.

**It is good and desirable for product teams to invent, prototype, ship, and maintain their own UI recipes.** In fact, [as Big Medium’s Brad Frost describes](https://bradfrost.com/blog/post/a-design-system-governance-process/), this is a formal part of [the design system governance workflow we recommend](https://coggle.it/diagram/XTZ3TKMV3SdbE6Pq/t/product-team-comes-to-design-help-design-and-build-new-work/).
...
*Is your design, development, or product organization struggling with process, delivery, or roles & responsibilities? We can help. Big Medium helps complex organizations do big design—building and shipping great digital products at scale. *[*Get in touch to find out how.*](https://bigmedium.com/hire/)

1. 
In some organizations, visual brand may be more fixed and slower moving; for the multi-brand design systems we create, we’re building design systems meant to support and outlast brands, sub-brands, and so on. So we think of brand as moving faster than infrastructure. [ ↩](https://bigmedium.com/ideas/design-system-pace-layers-slow-fast.html#fnref:82730)