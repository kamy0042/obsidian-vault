---
title: "The design engineer symptom: what a rising job title reveals"
source: "https://medium.com/user-experience-design-1/the-design-engineer-symptom-what-a-rising-job-title-reveals-850d5e4fd9cc"
author:
  - "[[Anna Lefour]]"
published: 2026-03-25
created: 2026-07-26
description: "Trying to define Design Engineering today, and why the confusion around it turned out to matter."
tags:
...
![Illustration of a woman standing thoughtfully with her hand on her chin, facing three framed scenes showing different versions of herself: one sketching wireframes on a tablet, one coding on a laptop, one presenting a document](https://miro.medium.com/v2/resize:fit:2000/format:webp/1*GTdkq3vDxBKx_zbNL4PSxQ.png)

“UX Designer”, “UX/UI Builder”, “UX Engineer”, “Product Builder”, “Design Engineer”… As job titles multiply, so does the confusion about what’s actually expected. — Made with Gemini
...
As I dove into the subject, I realised that I wasn’t the only one feeling lost. During an online event about [Design Salaries in 2026](https://www.youtube.com/watch?v=B37Sp0HvFrY&t=61s), organized by [The Product Crew](https://tpc-recrutement.com/), Design Engineering was mentioned, and the participants comments were revealing.

![Three lined-up, anonymized comments about design engineering, styled as social network comments.](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*l_PQWXGr1rbbrtm7jCvI4w.png)

A selection of comments (anonymized and translated from French) that caught my eyes during the Design Salaries in 2026 online event, that match the interrogations that led me to write this article. — Credit: Anna Lefour
...
A Design Engineer can take a concept from initial idea to shipped product, fluent enough in both languages to translate between them without losing fidelity ([Gonzalez, 2024](https://www.ryngonzalez.com/blog/the-attributes-of-a-design-engineer)). **What makes the role distinct is less about the toolset and more about a particular mindset: end-to-end ownership**. As [Yann-Edern Guillet](https://yannglt.com/writing/the-rosetta-stone-of-design-engineering) puts it, the design engineer is a live translator, “ *when designing, thinking about constraints and implementation; when coding, thinking about intent and aesthetics* ”.
...
I first read about UX-dev new AI workflows experiments in mid-2025, through Lital Poria article “ [From Pixel-Perfect to AI-First: How Jit Revolutionized Our UX-Dev Workflow](https://www.jit.io/resources/app-security/from-pixel-perfect-to-ai-first-how-jit-revolutionized-our-ux-dev-workflow) ”, where she explained how she went from Figma to Cursor.

Since then, more organisations are experimenting with new design-dev workflows, sometimes under a clearer “Design Engineering” brand. It was

[UXDX](https://medium.com/u/5a1684414693?source=post_page---user_mention--850d5e4fd9cc---------------------------------------)

that brought the sharpest focus to that label, with their free online event in February 2026, “ [Establishing Design Engineering](https://uxdx.com/session/establishing-design-engineering/) ” where product designer Ella Moran and software engineer Anna Spyker, at [Tracksuit](https://www.gotracksuit.com/us), a brand tracking platform, shared how they had built the practice from scratch.

![UXDX online conference banner titled “Empowering Product Design Teams” featuring the UXDX logo top left, a photo of Lead Engineer Anna Spyker bottom left, and a photo of Product Designer Ella Moran bottom right](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*zTOOCmPxJMwuCJTxuBc0yg.jpeg)

Credit: courtesy of UXDX.
...
![A linear, four-block graph representing Tracksuit design-dev workflow with AI: Claude frontend agent setup, changes by the designer, pull request by the designer, merge if the request passed the code review](https://miro.medium.com/v2/resize:fit:2000/format:webp/1*9mtS8i5JOTgCqvoy7X6BqQ.png)

At Tracksuit, Ella Moran’s pull requests undergo the same review process as those of the engineers. Graph credit: Anna Lefour.

A similar experiment ran at a larger scale at Alan, presented [during a live organised by The Product Crew](https://www.youtube.com/watch?v=6bDXDNIxlmk&t=2s). Laure Boutmy, product designer, and Tim Petricola, software engineer, built their “Everyone Can Build” initiative around a core observation: developer dependency was a genuine brake on product velocity. ==**Their solution repositioned code as a shared interface between all roles**====.== Designers and some product managers now contribute directly to the codebase via Cursor and Figma MCP, each paired with a dedicated engineering reference who has the final responsibility for merging to production. Tim mentioned that in Q4, they had “ *over 350 pull requests merged so far. The vast majority of designers have been onboarded; they’re active, so they’re really using Cursor and submitting pull requests.*”

![A linear, four-block graph representing Alan design-dev workflow with AI: Cursor setup, changes by the designer in Cursor, pull request by the designer, merge only by the engineer paired with the designer.](https://miro.medium.com/v2/resize:fit:2000/format:webp/1*QeeOoaYFrQLgpvDjGDnThQ.png)

At Alan, only engineers are allowed to push code in production. Graph credit: Anna Lefour.
...
![Abstract illustration of the blurring boundaries between Designer, Engineer, and Product Manager roles, represented by three colored, uneven rounded shapes.](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*qmincPL-VKsmyr4wGh2txA.png)
