---
タグ: []
作成日時: 2024-10-13T23:05:00
URL: https://medium.com/@NateBaldwin/when-semantic-tokens-are-no-longer-semantic-d65ef16fadd7
Tags: [topic/デザインシステム/デザイントークン]
---
![[0-fyQZo9Oqik0QnSj 1.png]]

Top highlight

# When “semantic tokens” are no longer semantic.

![](https://miro.medium.com/v2/resize:fill:88:88/1*xrTOjmPGml0s_ntynZY65A@2x.jpeg)

[Nate Baldwin](https://medium.com/@NateBaldwin)

·

[Follow](https://medium.com/m/signin?actionUrl=https%3A%2F%2Fmedium.com%2F_%2Fsubscribe%2Fuser%2F7a84b3976523&operation=register&redirect=https%3A%2F%2Fmedium.com%2F%40NateBaldwin%2Fwhen-semantic-tokens-are-no-longer-semantic-d65ef16fadd7&user=Nate%20Baldwin&userId=7a84b3976523)
...
There is a wide range of use case coverage and contextual precision we can have with semantic tokens. We can be more or less specific in order to apply them in more or less specific use cases. [Source image](https://medium.com/@NateBaldwin/creating-a-flexible-design-token-taxonomy-for-intuits-design-system-81c8ff55c59b).

![](https://miro.medium.com/v2/resize:fit:700/0*-fyQZo9Oqik0QnSj.png)
...
![](https://miro.medium.com/v2/resize:fit:700/1*6RT8a4vMJ3ZRvMZOChsYlA.png)
...
![](https://miro.medium.com/v2/resize:fit:700/1*T0tdu-K0bdcFqX_QMG2Oog.png)
...
![](https://miro.medium.com/v2/resize:fit:700/1*alJxBuEan4-U9DhF_XSC7g.png)
...
![](https://miro.medium.com/v2/resize:fit:700/1*GQMrbCHee7R2hb94C46acg.png)
...
![](https://miro.medium.com/v2/resize:fit:700/1*oYjCo7FIjG4WcUfsHrpgeA.png)
...
![](https://miro.medium.com/v2/resize:fit:700/1*WEI92rjWrOvdphhd0YzSCw.jpeg)