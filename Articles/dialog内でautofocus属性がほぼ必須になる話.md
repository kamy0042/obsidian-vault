---
タグ: []
作成日時: 2023-02-14T11:55:00
URL: https://zenn.dev/yusukehirao/articles/e5df3d60c99e91
...
! 「**シーケンシャルフォーカス可能な要素**」はタブキーでの移動が可能な要素を指していて、`tabindex="-1"`をもつ要素はこれに該当しません[[1]](https://zenn.dev/yusukehirao/articles/e5df3d60c99e91#fn-6d49-1)。このあたり名称に関して「**first-focusable**」や「**first-tabbable**」などの用語が提案[[2]](https://zenn.dev/yusukehirao/articles/e5df3d60c99e91#fn-6d49-2)されています。そちらも興味があればチェックしてください。 
また、スクロール可能要素をシーケンシャルフォーカス可能にすること[[3]](https://zenn.dev/yusukehirao/articles/e5df3d60c99e91#fn-6d49-3)についても提案では言及されています。Firefoxでは既に実装されていて、Chromeは[実装中](https://bugs.chromium.org/p/chromium/issues/detail?id=1040141)、Webkitは未実装となっています。さらにアクセシビリティツリーに「**scrollable**」というプロパティを公開する提案[[4]](https://zenn.dev/yusukehirao/articles/e5df3d60c99e91#fn-6d49-4)も進んでいます。
...
1. 
whatwg/html [Initial focus placement for dialog element: terminology for first-focusable vs first-tabbable #7710](https://github.com/whatwg/html/issues/7710) [↩︎](https://zenn.dev/yusukehirao/articles/e5df3d60c99e91#fnref-6d49-2)
2. 
スクロール可能要素がフォーカス可能要素を内包していない場合、スクロール位置の変更をキーボードによって操作できない問題への解決策。 [↩︎](https://zenn.dev/yusukehirao/articles/e5df3d60c99e91#fnref-6d49-3)

[GitHubで編集を提案](https://github.com/YusukeHirao/zenn/blob/main/articles/e5df3d60c99e91.md)
