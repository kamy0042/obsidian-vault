---
タグ: []
作成日時: 2023-10-30T13:08:00
URL: https://www.trysmudford.com/blog/design-foundations/
Tags: [topic/組織/デザインエンジニアリング]
---
This post is part of a series on Design Engineering. You can read the [main post](https://www.trysmudford.com/blog/i-think-im-a-design-engineer), a post on the design engineers [approach to prototyping](https://www.trysmudford.com/blog/prototyping), or one on the [designer developer relationship](https://www.trysmudford.com/blog/designer-and-developer-relationship/).
...
![[colour-function-two.png]]

Multiple colours in a swatch, with tints and shades
...
Creating this backbone of logic will go a long way to bridging that gulf between the subjective and objective[1](https://www.trysmudford.com/blog/design-foundations/#fn:1). I believe that the more ‘system-y’ your design is, the more accurately an engineer will recreate it. If you can explain the logic that goes into a design decision, other designers and engineers are more likely to apply the same pattern for similar use-cases.
...
![[colour-function-three.png]]

A colour matrix demonstrating all the tints and shades

For typography, that could be a type scale visualisation:

![[de-type-scale.png]]

A type scale visualisation from step 0 to 5
