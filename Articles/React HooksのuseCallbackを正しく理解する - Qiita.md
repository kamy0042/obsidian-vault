...
なので、ローカル関数にする場合が多くなるでしょう。しかし、ローカル関数は、render時点でのローカル変数をキャプチャしてしまう[1](https://qiita.com/uehaj/items/99f7cd014e2c0fa1fc4e) ので、へたに保存して使いまわそうとすると、一般に非同期に呼び出されるイベントハンドラでは、そのキャプチャ元の変数の最新の値を使って処理できない、という問題があります。使いまわさなければいいんですけどね。使いまわしたくなる事情もあるのです。
...
[Sign up](https://qiita.com/signup?callback_action=login_or_signup&redirect_to=%2Fuehaj%2Fitems%2F99f7cd014e2c0fa1fc4e&realm=qiita)

[Login](https://qiita.com/login?callback_action=login_or_signup&redirect_to=%2Fuehaj%2Fitems%2F99f7cd014e2c0fa1fc4e&realm=qiita)